...
select 
    ...
    tempoHost,
    accommodates,
    round((price/accommodates),2) as price_per_accommodates,
    bathrooms,
    round((price/bathrooms),2) as price_per_bathrooms,
    bedrooms,
    round((price/bedrooms),2) as price_per_bedrooms,
    beds,
    round((price/beds),2) as price_per_beds,
    weekly_price, 
    monthly_price, 
    security_deposit,
    cleaning_fee, 
    ...
    availability_90,
    availability_365,
    round((availability_30 + availability_60 + availability_90 + availability_365)/4) as mean_availability,
    round((number_of_reviews/tempoHost),2) as review_per_year,
    price
    from tb_allColumns
) 
...
SELECT 
    ...
    t2.tempoHost,
    t2.accommodates,
    t2.price_per_accommodates,
    t2.bathrooms,
    t2.price_per_bathrooms,
    t2.bedrooms,
    t2.price_per_bedrooms,
    t2.beds,
    t2.price_per_beds,
    t2.weekly_price,
    t2.monthly_price,
